...
* Dispatchers for now have to create or update Package or Package Events   by using testing tool like postman.Used upsert in backend to handle package create and update which is ok for demo use. 
